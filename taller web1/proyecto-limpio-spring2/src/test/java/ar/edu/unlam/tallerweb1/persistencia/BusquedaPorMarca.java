	...
	public void BuscarMarca(){
		...
		getSession().save(miAuto1 );
			...
			getSession().save(miAuto2);
				...
				getSession().createCriteria(Auto.class).createAlias("modelo.marca","marcaBuscada").add(Restrictions.eq("marcaBuscada.nombre","Peugeot")).list();
