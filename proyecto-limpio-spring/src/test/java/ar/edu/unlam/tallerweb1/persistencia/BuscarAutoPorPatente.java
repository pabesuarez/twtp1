...
public class BuscarAutoPorPatente extends SpringTest {
	@Test
	@Transactional @Rollback(true)
	public void BuscarAutoPatente(){
    	...
    	Resultado = (Auto) getSession().createCriteria(Auto.class).add(Restrictions.eq("patente","EEE 555")).uniqueResult();
    	
    
    		assertThat(Resultado.getPatente()).isEqualTo("EEE 555");
